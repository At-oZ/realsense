...
//                    //std::string filenamein = "./images/lenna/prop-reconstruction/v1-2/comparison/prop-lenna-v1-2_ImgDisplay_NumPinhole" + std::to_string(num_pinhole_per_axis) + "_NumZLevel" + std::to_string(num_z_level) + "_subjectZ" + std::to_string((int)subject_z) + ".png";
//                    std::string filenamein = "./images/lenna/prop-reconstruction/v0/comparison/prop-lenna-v0_ImgDisplay_NumPinhole" + std::to_string(num_pinhole_per_axis) + "_NumZLevel" + std::to_string(num_z_level) + "_subjectZ" + std::to_string((int)subject_z) + ".png";
