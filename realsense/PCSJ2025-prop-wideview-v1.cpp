            ...
            for (int pt = 3; pt <= 3; pt++) {
                ...
                for (int nzl = 60; nzl <= 60; nzl += 5) {
                    ...
                    for (double subz = 300.0; subz <= 1000.0; subz += 100) {
                        ...
                        stream << "D:/ForStudy/reconstruction/PCSJ2025-prop-wideview-v1/prop-wideview-v1-mandrill_f" << std::fixed << std::setprecision(4) << focal_length << "_subsize" << std::fixed << std::setprecision(2) << subject_size << "_zi" << (int)subz << ".png";
