...
///* 差分:計算の高速化の検討(pcd_boxからr, g, b, aへの分離) */
//
...
//            threads.emplace_back(insert_pixels, startRow, endRow, img_display, red, green, blue, alpha, sp, tp);
//        }
//
//        for (auto& t : threads) {
...
//        stream << "./images/prop-v1-2_ImgDisplay_NumZLevel" << num_z_level << "_Ddash" << Ddash << "_pitchTimes" << fixed << setprecision(2) << ptimes << "_boxSize" << box_size << ".png";
