...
//                //filenameout_stream << "D:/ForStudy/observe-images/real-direct/subz_" << static_cast<int>(subz) << "mm/real-direct-mandrill-observe_" << NUM_LENS_X << "px_zi" << static_cast<int>(subz) << "_xo" << static_cast<int>(observer_x[nobs] * 1000) << "um_yo" << static_cast<int>(observer_y[nobs] * 1000) << "um_zo" << static_cast<int>(observer_z[nobs]) << "mm.png";
...
//                //cv::imwrite(std_filenameout, standard_image);
