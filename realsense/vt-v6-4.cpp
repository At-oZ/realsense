...
//
//                nx = static_cast<int>(round(tmp_pcd_x - sum_h_disparity));
//                ny = static_cast<int>(round(tmp_pcd_y - sum_v_disparity));
//
...
//        stream << "./images/v6-2_img_display_g" << g << "_wp" << fixed << setprecision(1) << wp << "_pd" << fixed << setprecision(3) << pd << "_D" << D << ".png";
//
