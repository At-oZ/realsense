...
//
//// パラメータ
//int num_z_level = 500; // イメージプレーンの層数
//double ptimes = 1; // イメージプレーンの画素ピッチの係数(1でディスプレイの画素ピッチと同じ)
//int box_size = 1; // 探索範囲
//
//double min_d = 100.0; // ディスプレイと一番手前のイメージプレーンの距離(+D mm)
...
//        stream << "./images/v11-7v_ImgDisplay_NumZLevel" << num_z_level << "_z" << tt << "_min_d" << min_d << "_max_d" << max_d << "_pitchTimes" << fixed << setprecision(3) << ptimes << "_boxSize" << box_size << ".png";
