...
//        //auto verts = points.get_vertices();
//        //for (int i = 0; i < WIDTH * HEIGHT; i++) {
//        //    outputFile << verts[i].x;
//        //    outputFile << ",";
//        //    outputFile << verts[i].y;
//        //    outputFile << ",";
//        //    outputFile << verts[i].z;
//        //    outputFile << ",";
//        //    outputFile << raw_pointclouddata[i * 3];
//        //    outputFile << ",";
//        //    outputFile << raw_pointclouddata[i * 3 + 1];
//        //    outputFile << ",";
//        //    outputFile << raw_pointclouddata[i * 3 + 2];
//        //    outputFile << "\n"; // 行の終わりに改行を出力
//        //}
//
//        //// ファイルを閉じる
...
//            threads.emplace_back(insert_pixels, WIDTH, HEIGHT, Wpin, N, D, g, wp, inv_wp, intv, startRow, endRow, uo, vo, raw_pointclouddata, std::ref(points), std::ref(img_display), val_z);
//        }
//
//        for (auto& t : threads) {
//            t.join();
...
//        //stream << "v13_img_display_g" << g << "_wp" << fixed << setprecision(1) << wp << "_pd" << fixed << setprecision(3) << pd << "_D" << D << ".png"; // 小数点以下2桁で切り捨て
