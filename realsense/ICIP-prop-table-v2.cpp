...
int main(int argc, char* argv[])
{
    ...
    std::vector<std::vector<double>> array(46, std::vector<double>(81)); // 横：subz, 縦：nzl
    ...
    for (int nph = 40; nph <= 40; nph *= 2) {
        ...
        for (int nzl = 10; nzl <= 100; nzl += 2) {
            ...
            int idx_subz = 0;
            for (double subz = 250.0; subz <= 8250.0; subz += 100) {
                ...
                for (int tt = 0; tt < TIMES; tt++) {
                    ...
                    stream << "C:/Users/taw11/EvacuatedStorage/prop-reconstruction/ICIP-prop-table-v2/prop-v2-detail-mandrill_tileExpand_Nz" << nzl << "_subjectZ" << (int)subz << ".png";
