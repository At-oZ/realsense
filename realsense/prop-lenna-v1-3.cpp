...
///*
//    v1-2との差分:点群取得カメラの位置を観察位置またはその1/2倍した距離の位置に固定
...
//
//                        if (0 <= tmp_nx && tmp_nx < boxel_cam_width_px && 0 <= tmp_ny && tmp_ny < boxel_cam_height_px && 0 <= tmp_nz && tmp_nz < num_z_level) {
//
