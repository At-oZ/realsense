...
//
//// パラメータ
//int num_z_level = 27; // イメージプレーンの層数
...
//
//        half_m = (double)m - (double)N * 0.5;
//
//        for (int n = 0; n < N; n++) {
//
//            half_n = (double)n - (double)N * 0.5;
//
//            // 各要素カメラごとに
...
//        stream << "./images/v11-5_ImgDisplay_NumZLevel" << num_z_level << "_Ddash" << Ddash << "_pitchTimes" << fixed << setprecision(2) << ptimes << "_boxSize" << box_size << ".png";
