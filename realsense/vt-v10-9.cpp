...
//const double trans_coef = max_z * D;
//
//// イメージプレーンの解像度
...
//
//                // 奥行き
//                zt = static_cast<int>(round(trans_coef / tmp_pcd_z));
...
//        stream << "mac_v10-7_img_display_g" << g << "_wp" << fixed << setprecision(1) << wp << "_pd" << fixed << setprecision(3) << pd << "_D" << D << ".png";
//
