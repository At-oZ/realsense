...
// パラメータ
int num_z_level = 10; // イメージプレーンの層数
...
int main(int argc, char* argv[])
{
    ...
    for (int tt = 0; tt < 1; tt++) {
        ...
        stream << "./images/v11-6_ImgDisplay_NumZLevel" << num_z_level << "_Ddash" << Ddash << "_pitchTimes" << fixed << setprecision(2) << ptimes << "_boxSize" << box_size << ".png";
