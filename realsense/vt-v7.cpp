...
//}
//
//void insert_pixels(int start, int end, int** img_display, double** data, double** val_z, double* uo, double* vo) {
//
//    int nx, ny;
//    int startv, startu;
//    double newx, newy;
...
//        }
//
//        // insert_pixels(0, Hpin, std::ref(img_display), std::ref(data), std::ref(val_z), std::ref(uo), std::ref(vo));
//
...
//        stream << "mac_v7_img_display_g" << g << "_wp" << fixed << setprecision(1) << wp << "_pd" << fixed << setprecision(3) << pd << "_D" << D << "_delta_width" << delta_width << "_delta_height" << delta_height << ".png";
//
