...
//        tmp_pcd_r = data[k][5];
//
//        tmp_pcd_x = tmp_pcd_x / tmp_pcd_z;
//        tmp_pcd_y = tmp_pcd_y / tmp_pcd_z;
//        tmp_pcd_z = 1.0 / tmp_pcd_z;
//
...
//                //cout << "i:" << i << ", j:" << j << endl;
//
//                newx = g * (tmp_pcd_x - tmp_pcd_z * uo[i * Wpin + j]);
//                newy = g * (tmp_pcd_y - tmp_pcd_z * vo[i * Wpin + j]);
//
...
//        stream << "./images/v1-3trans_img_display_g" << g << "_wp" << fixed << setprecision(1) << wp << "_pd" << fixed << setprecision(3) << pd << "_D" << D << ".png";
