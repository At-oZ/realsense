...
///* 差分:実際に再構成(再チャレンジ)→一応結果は出たが、式が複雑 */
//
...
//
//                        tmp_nx = (g / full_nz) * full_nx;
//                        tmp_ny = (g / full_nz) * full_ny;
//
...
//        stream << "mac_v11_ImgDisplay_NumZLevel" << num_z_level << "_Ddash" << Ddash << "_g" << g << "_wp" << fixed << setprecision(1) << wp << "_pd" << fixed << setprecision(3) << pd << "_D" << D << ".png";
...
//
//            stream << "mac_v11_NumZLevel" << num_z_level <<"_zi" << zi << "_Ddash" << Ddash << "_g" << g << "_wp" << fixed << setprecision(1) << wp << "_pd" << fixed << setprecision(3) << pd << "_D" << D << ".png";
//            cout << "zi:" << zi << endl;
//            
