...
//
//                        nx = static_cast<int>(floor((tmp_nx + px_width_img * 0.5 * img_pitch) / img_pitch));
//                        ny = static_cast<int>(floor((tmp_ny + px_height_img * 0.5 * img_pitch) / img_pitch));
//
...
//
//            tmp_pcd0 = data[k][0] * 1000;
//            tmp_pcd1 = data[k][1] * 1000;
//            tmp_pcd2 = data[k][2] * 1000 + D;
//            tmp_pcd3 = data[k][3];
//            tmp_pcd4 = data[k][4];
//            tmp_pcd5 = data[k][5];
//
//            inv_d = 1.0 / tmp_pcd2;
//
//            newx = (g * inv_d) * tmp_pcd0;
//            newy = (g * inv_d) * tmp_pcd1;
//
...
//        stream << "./images/v11-4_ImgDisplay_NumZLevel" << num_z_level << "_Ddash" << Ddash << "_g" << g << "_wp" << fixed << setprecision(1) << wp << "_pd" << fixed << setprecision(3) << pd << "_D" << D << ".png";
...
//
//            stream << "./images/v11-4_NumZLevel" << num_z_level <<"_zi" << zi << "_Ddash" << Ddash << "_g" << g << "_wp" << fixed << setprecision(1) << wp << "_pd" << fixed << setprecision(3) << pd << "_D" << D << ".png";
//            cout << "zi:" << zi << endl;
//            
