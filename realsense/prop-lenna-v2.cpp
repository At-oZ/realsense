...
//int num_pinhole = 200;  // 各軸方向のピンホール数
...
//double ptimes = 5.0; // イメージプレーンの画素ピッチの係数(1でディスプレイの画素ピッチと同じ)
//int half_box_size = (int)ptimes - 1; // 探索範囲
//
//double Ddash = 250.0;
...
//        stream << "./images/lenna/prop-reconstruction/v2/prop-lenna-v2_ImgDisplay_NumZLevel" << num_z_level << "_Ddash" << Ddash << "_pitchTimes" << static_cast<int>(ptimes) << "_subjectZ" << (int)subject_z << ".png";
