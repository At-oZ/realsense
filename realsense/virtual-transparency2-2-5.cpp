...
//    // 'image' should be a 3*width*height sized vector (or array) containing your RGB values
...
//        std::vector<unsigned char> img_display(pw_disp * ph_disp * 4);
//
...
//                            size_t index = ((startv + ny) * pw_disp + (startu + nx)) * 4;
//
//                            img_display[index] = color_data[k * 3 + 2];
//                            img_display[index + 1] = color_data[k * 3 + 1];
//                            img_display[index + 2] = color_data[k * 3];
//                            img_display[index + 3] = 255;
...
//
//        saveImage("test.png", img_display, pw_disp, ph_disp);
//
