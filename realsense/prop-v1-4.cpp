...
///* 差分:計算の高速化の検討(pcd_boxからr, g, b, aへの分離 & 逐次計算ではなく差分の積算) */
//
...
//        stream << "./images/prop-v1-4_ImgDisplay_NumZLevel" << num_z_level << "_Ddash" << Ddash << "_pitchTimes" << fixed << setprecision(2) << ptimes << "_boxSize" << box_size << ".png";
