...
//    sum_box = (double***)malloc(sizeof(double**) * num_z_level);
//    pcd_color_box = (int****)malloc(sizeof(int***) * num_z_level);
//    for (int i = 0; i < num_z_level; i++) {
//        pcd_box[i] = (int**)malloc(sizeof(int*) * px_height_img);
//        sum_box[i] = (double**)malloc(sizeof(double*) * px_height_img);
//        pcd_color_box[i] = (int***)malloc(sizeof(int**) * px_height_img);
//        for (int j = 0; j < px_height_img; j++) {
//            pcd_box[i][j] = (int*)malloc(sizeof(int) * px_width_img);
//            sum_box[i][j] = (double*)malloc(sizeof(double) * px_width_img);
//            pcd_color_box[i][j] = (int**)malloc(sizeof(int*) * px_width_img);
//            for (int k = 0; k < px_width_img; k++) {
//                pcd_color_box[i][j][k] = (int*)malloc(sizeof(int) * 3);
//            }
//        }
//    }
//
...
//                    pcd_box[i][j][k] = 0;
//                    sum_box[i][j][k] = 0;
//                    pcd_color_box[i][j][k][0] = 0;
//                    pcd_color_box[i][j][k][1] = 0;
//                    pcd_color_box[i][j][k][2] = 0;
//                }
//            }
//        }
//
...
//
//                    pcd_color_box[nz][ny][nx][0] += static_cast<unsigned char>(tmp_pcd_b);
//                    pcd_color_box[nz][ny][nx][1] += static_cast<unsigned char>(tmp_pcd_g);
//                    pcd_color_box[nz][ny][nx][2] += static_cast<unsigned char>(tmp_pcd_r);
//                    sum_box[nz][ny][nx]++;
//
//                }
//
...
//                for (int k = 0; k < px_width_img; k++) {
//                    if (sum_box[i][j][k] > 0) {
//                        pcd_box[i][j][k] = static_cast<unsigned char>(round(pcd_color_box[i][j][k][0] / sum_box[i][j][k])) + static_cast<unsigned char>(round(pcd_color_box[i][j][k][1] / sum_box[i][j][k])) * 256 + static_cast<unsigned char>(round(pcd_color_box[i][j][k][2] / sum_box[i][j][k])) * 256 * 256 + 256 * 256 * 256;
//                        //cout << "pcd_box:" << pcd_box[i][j][k] << endl;
//                    }
//                }
//            }
//        }
...
//        stream << "./images/v12_1_ImgDisplay_NumZLevel" << num_z_level << "_Ddash" << Ddash << "_pitchTimes" << fixed << setprecision(2) << ptimes << "_boxSize" << box_size << ".png";
