...
//        stream << "./images/v12-1/v12-1_ImgDisplay_NumZLevel" << num_z_level << "_Ddash" << Ddash << "_pitchTimes" << fixed << setprecision(2) << ptimes << "_boxSize" << box_size << ".png";
...
//
//            stream << "./images/v12-1/imagePlane/NumZLevel" << num_z_level << "/ptimes" << fixed << setprecision(2) << ptimes << "/v12-1_imagePlane_NumZLevel" << num_z_level << "_zi" << zi << "_Ddash" << Ddash << "_pitchTimes" << fixed << setprecision(2) << ptimes << ".png";
//            //cout << "zi:" << zi << endl;
//
