...
//                newy = -(g * inv_d) * (vo[i * Hpin + j] - tmp_pcd1 * 1000);
//
...
//                    if (val_z[startv + ny][startu + nx] > tmp_pcd2) {
//
//                        img_display[startv + ny][startu + nx] = static_cast<unsigned char>(tmp_pcd3) + static_cast<unsigned char>(tmp_pcd4) * 256 + static_cast<unsigned char>(tmp_pcd5) * 256 * 256;
//                        val_z[startv + ny][startu + nx] = tmp_pcd2;
//                    }
//                }
//            }
//        }
...
//        stream << "./images/v1-2_img_display_g" << g << "_wp" << fixed << setprecision(1) << wp << "_pd" << fixed << setprecision(3) << pd << "_D" << D << ".png";
