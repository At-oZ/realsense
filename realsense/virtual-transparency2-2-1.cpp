...
//using namespace std;
//
//void insert_pixels(int WIDTH, int HEIGHT, int Wpin, int N, int D, double g, double wp, double inv_wp, int starty, int endy, double* uo, double* vo, int* elem_img, double* pointclouddata, double* val_z) {
//
...
//
//        tmp_pcd0 = pointclouddata[k * 6];
//        tmp_pcd1 = pointclouddata[k * 6 + 1];
//        tmp_pcd2 = pointclouddata[k * 6 + 2];
//        tmp_pcd3 = pointclouddata[k * 6 + 3];
//        tmp_pcd4 = pointclouddata[k * 6 + 4];
//        tmp_pcd5 = pointclouddata[k * 6 + 5];
//
//        //if (k % 1000 == 0) {
//        //    cout << "k:" << k << "\n" << endl;
//        //}
...
//            threads.emplace_back(insert_pixels, WIDTH, HEIGHT, Wpin, N, D, g, wp, inv_wp, startRow, endRow, uo, vo, elem_img, raw_pointclouddata, val_z);
//        }
//
//        for (auto& t : threads) {
//            t.join();
...
//        stream << "v9_img_display_g" << g << "_wp" << fixed << setprecision(1) << wp << "_pd" << fixed << setprecision(3) << pd << "_D" << D << ".png"; // 小数点以下2桁で切り捨て
