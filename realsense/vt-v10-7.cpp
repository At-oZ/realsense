...
//        stream << "./images/v10-7_img_display_g" << g << "_wp" << fixed << setprecision(1) << wp << "_pd" << fixed << setprecision(3) << pd << "_D" << D << ".png";
//
...
//        for (int zi = 0; zi < num_z_level; zi++) {
//
//            stream << "./images/imagePlane/v10-7_imagePlane_NumZLevel" << num_z_level << "_zi" << zi << "_Ddash" << Ddash << "_pitchTimes" << fixed << setprecision(2) << ptimes << ".png";
//            cout << "zi:" << zi << endl;
//
//            for (int i = 0; i < px_height_img; i++) {
//                for (int j = 0; j < px_width_img; j++) {
