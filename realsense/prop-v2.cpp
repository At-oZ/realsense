...
//
//    //            tmp_startv = static_cast<int>(i * N);
//
//    //            for (int j = 0; j < Wpin; j++) {
//
//    //                tmp_startu = static_cast<int>(j * N);
//
//    //                // 各奥行きレベルごとに(手前から)
...
//    //                            // std::cout << "v, u:" << startv + m << ", " << startu + n << endl;
//    //                            break;
//    //                        }
//    //                    }
//    //                }
...
//    // std::cout << "average of zi:" << sum_zi << endl;
//
...
//            tmp_pcd_g = data[k][4];
//            tmp_pcd_r = data[k][5];
//            tmp_coef = 1.0 / (tmp_pcd_z * tmp_pcd_z);
//
//            for (int i = 0; i < Wpin; i++) {
//                up[i] = static_cast<int>(round(g * (tmp_pcd_x - sp[i]) / tmp_pcd_z) + N / 2);
//            }
//            for (int i = 0; i < Hpin; i++) {
//                vp[i] = static_cast<int>(round(g * (tmp_pcd_y - tp[i]) / tmp_pcd_z) + N / 2);
//            }
//
//            //for (int i = 0; i < Hpin; i++) {
//            //    if (vp[i] >= 0 && vp[i] < N) {
...
//        stream << "./images/prop-v2_ImgDisplay.png";
