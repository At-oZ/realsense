...
//}
//
//void reconstruction(int start, int end, int rows, int num_pinhole, double gap, double display_pixel_pitch, int element_image_px, double intv, cv::Mat img_display, double* sp, double* tp, double** data, double** val_z) {
//
...
//                    threads.emplace_back(reconstruction, startRow, endRow, rows, num_pinhole, gap, display_pixel_pitch, element_image_px, intv, std::ref(img_display), std::ref(sp), std::ref(tp), std::ref(data), std::ref(val_z));
//                }
//
//                for (auto& t : threads) {
