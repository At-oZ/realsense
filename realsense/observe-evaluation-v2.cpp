...
//                        std::string filename_display_compared = "D:/EvacuatedStorage/prop-reconstruction/ICIP-prop-improve-v1-2/prop-improve-v1-2-milkdrop_tileExpand_Nx" + std::to_string(NxNy) + "_Ny" + std::to_string(NxNy) + "_Nz" + std::to_string(nzl) + "_N" + std::to_string(pt) + "_zi" + std::to_string((int)subz) + ".png";  //  提案手法(完成版3)
