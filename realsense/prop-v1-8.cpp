...
///* 差分:再構成品質の改善の検討(v1-7の変更点 & 重なり点群を平均化)→ 17.3476 dB から 17.2927 dBに減少... */
//
...
//        stream << "./images/prop-v1-8_ImgDisplay_NumZLevel" << num_z_level << "_Ddash" << Ddash << "_pitchTimes" << fixed << setprecision(2) << ptimes << "_boxSize" << box_size << ".png";
