...
///* 差分:計算の高速化の検討(v1-4の変更点 & 計算のメモリアクセス化(nx, nyまで))→215msから70msまで短縮成功! */
//
...
//        stream << "./images/prop-v1-7_ImgDisplay_output-v3_NumZLevel" << num_z_level << "_Ddash" << Ddash << "_pitchTimes" << fixed << setprecision(2) << ptimes << "_boxSize" << box_size << ".png";
