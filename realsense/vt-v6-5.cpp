...
//        tmp_pcd_r = data[k][5];
//
//        h_disparity = (g / tmp_pcd_z) * wp;
//        v_disparity = (g / tmp_pcd_z) * wp;
//        // cout << "h disparity:" << h_disparity << ", v disparity:" << v_disparity << endl;
//
//        sum_v_disparity = v_disparity * start;
//
...
//
//            sum_h_disparity = 0.0;
//            //sum_v_disparity = v_disparity * i;
//
//            //diff_disparity = sum_v_disparity - v_disparity * i;
//            //if (diff_disparity > 0) {
//            //    cout << "vertical difference detected:" << diff_disparity << endl;
//            //}
//
//            for (int j = 0; j < Wpin; j++) {
//
//                startu = static_cast<int>(j * intv);
//                //sum_h_disparity = h_disparity * j;
//
//                u = tmp_pcd_x - sum_h_disparity;
//                v = tmp_pcd_y - sum_v_disparity;
//
//                //cout << "u: " << u << ", v: " << v << endl;
//
//                nx = static_cast<int>(floor((u + wp * 0.5) * N / wp));
//                ny = static_cast<int>(floor((v + wp * 0.5) * N / wp));
//
...
//            }
//
//            //diff_disparity = sum_h_disparity - h_disparity * Wpin;
//            //if (diff_disparity > 0) {
//            //    cout << "horizontal difference detected:" << diff_disparity << endl;
//            //}
//
...
//
//            //cout << "x: " << tmp_pcd_x << ", y: " << tmp_pcd_y << ", z: " << tmp_pcd_z << endl;
//
//            inv_d = 1.0 / tmp_pcd_z;
//
//            data[k][0] = (g * inv_d) * ((Wpin - 1) * 0.5 * wp + tmp_pcd_x);
//            data[k][1] = (g * inv_d) * ((Hpin - 1) * 0.5 * wp + tmp_pcd_y);
//            data[k][2] = tmp_pcd_z;
//
//            //cout << "data x:" << data[k][0] << ", data y:" << data[k][1] << ", data z:" << data[k][2] << endl;
//
//        }
//
//        for (int i = 0; i < ph_disp; i++) {
...
//        }
//
//        //insert_pixels(0, Hpin, std::ref(img_display), std::ref(data), std::ref(val_z));
//
...
//            threads.emplace_back(insert_pixels, startRow, endRow, std::ref(img_display), std::ref(data), std::ref(val_z));
//        }
//
//        for (auto& t : threads) {
...
//        stream << "./images/v6-5_img_display_g" << g << "_wp" << fixed << setprecision(1) << wp << "_pd" << fixed << setprecision(3) << pd << "_D" << D << ".png";
//
...
//
//        ostringstream stream;
//        stream << "./images/v1-3_v6-5_diff_img.png";
//        cv::String filename = stream.str();
//
