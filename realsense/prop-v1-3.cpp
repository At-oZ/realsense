...
///* 差分:計算の高速化の検討(pcd_boxで一括 & 逐次計算ではなく差分の積算) */
//
...
//}
//
//void insert_pixels(int start, int end, cv::Mat img_display, int*** pcd_box, double* sp, double* tp) {
//
...
//        stream << "./images/prop-v1-3_ImgDisplay_NumZLevel" << num_z_level << "_Ddash" << Ddash << "_pitchTimes" << fixed << setprecision(2) << ptimes << "_boxSize" << box_size << ".png";
