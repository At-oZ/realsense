...
//        stream << "./images/v11-6v_ImgDisplay_NumZLevel" << num_z_level << "_z" << tt << "_Ddash" << Ddash << "_pitchTimes" << fixed << setprecision(3) << ptimes << "_boxSize" << box_size << ".png";
