...
//        stream << "D:/EvacuatedStorage/prop-reconstruction/IE-prop-normal-v1/prop-normal-v1-milkdrop_f" << std::fixed << std::setprecision(4) << focal_length << "_subsize" << std::fixed << std::setprecision(2) << subject_size << "_zi" << (int)subz << ".png";
